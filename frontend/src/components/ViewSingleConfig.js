    ...
    <>
      ...
      >
        ...
        <Modal.Body className="px-0">
          <Row>
            <Modal.Title className="text-center pt-3 pb-4">
              {config.model}
            </Modal.Title>
          </Row>
              ...
              <Table striped bordered hover variant="dark" className="px-5">
                <tbody>
                  ...
                  <tr className="textSize">
                    ...
                    <td>
                      {config.cabinetSizeW} mm x {config.cabinetSizeH} mm
                    </td>
                  </tr>
                  <tr className="textSize">
                    <td>Cabinet Resolution</td>
                    <td>
                      {config.cabinetResW} px x {config.cabinetResH} px
                    </td>
                  </tr>
                  <tr className="textSize">
                    <td>Module Size</td>
                    <td>
                      {config.moduleSizeW} mm x {config.moduleSizeH} mm{' '}
                    </td>
                  </tr>
                  <tr className="textSize">
                    <td>Module Resolution</td>
                    <td>
                      {config.moduleResW} px x {config.moduleResH} px
                    </td>
                  </tr>
                  <tr className="textSize">
                    <td>Module Config</td>
                  ...
                  <tr className="textSize">
                    ...
                    <td>
                      {config.maxPower} W/m <sub>2</sub> (max.)
                    </td>
                  </tr>
                  <tr className="textSize">
                    <td>Avg Power Consumption</td>
                    <td>
                      {config.avgPower} W/m <sub>2</sub> (typ.)
                    </td>
                  </tr>
                </tbody>
              </Table>
